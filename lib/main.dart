...
class _BluetoothChatScreenState extends State<BluetoothChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(isConnected ? 'محادثة مع: ${selectedDevice?.name}' : 'غرفة محادثة البلوتوث'),
        actions: [
          IconButton(
        ...
        children: [
          if (!isConnected) ...[
            const Padding(
              ...
              child: Text('اختر جهازاً مقترناً للاتصال به:', style: TextStyle(fontWeight: FontWeight.bold)),
            ),
            Expanded(
